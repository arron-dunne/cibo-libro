    ...
    <div className={dark ? "dark" : ""}>
      <div className="min-h-dvh bg-gradient-to-br from-orange-400 via-orange-500 to-rose-500 text-slate-900 dark:from-neutral-900 dark:via-neutral-950 dark:to-black dark:text-neutral-100">
        ...
        <main className="mx-auto max-w-6xl px-4 pt-6 md:pt-10">
          {/* Floating Action Bar (visual draft, button-only) */}
          <div className="relative h-0">
            <div
              className="
      absolute left-1/2 top-0 z-40 w-full max-w-lg -translate-x-1/2 -translate-y-1/2
      rounded-full border border-white/40 bg-white/70 px-3 py-2 shadow-xl backdrop-blur
      dark:border-neutral-700 dark:bg-neutral-900/70
      flex items-center justify-center gap-2
    "
            >
              {/* Back (visual only) */}
              <button className="inline-flex items-center gap-2 rounded-full border border-orange-200/70 bg-white px-3 py-1.5 text-xs font-semibold text-orange-700 shadow-sm hover:bg-orange-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700">
                {/* replace with ArrowLeft if you import it */}
              ...
              {/* Delete (danger style but still a visual button) */}
              <button className="inline-flex items-center gap-2 rounded-full border border-red-300/60 bg-white px-3 py-1.5 text-xs font-semibold text-red-600 shadow-sm hover:bg-red-50 dark:border-red-700 dark:bg-neutral-800 dark:text-red-400 dark:hover:bg-neutral-700">
                {/* replace with Trash2 if you import it */}
                <ExternalLink className="h-4 w-4" />
                Delete
              </button>
              ...
              <button
                onClick={() => {
                  // visual behaviour only: smooth-scroll to steps if present
