...
/**
 * Import landing page: simple, focused form + clear compliance note.
 */
    ...
    <div className="relative">
      <div className="mx-auto max-w-2xl rounded-2xl bg-white/95 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur">
        <header className="mb-6">
          <h1 className="text-3xl font-semibold tracking-tight text-gray-900">Import a recipe</h1>
          <p className="mt-2 text-sm text-gray-600">
            Paste a link to a recipe. If we can read the important bits, we’ll save them to your cookbook. If not,
            we’ll keep a handy card that links back to the original page.
          </p>
        </header>
        ...
        <form action={importRecipe} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={2000}
            />
            <p className="mt-1 text-xs text-gray-500">Tip: Use a direct recipe page (not a homepage).</p>
          </div>

          <div className="flex items-center gap-3 pt-2">
            <SubmitButton />
            <Link href="/recipes" className="text-sm font-medium text-orange-800 underline-offset-4 hover:underline">
              Back to recipes
            </Link>
          </div>

          <div className="mt-4 rounded-xl bg-orange-50 p-3 text-xs text-orange-900">
            <strong className="font-semibold">Heads up:</strong> Imported content stays{" "}
            <span className="font-semibold">private to you</span>. We always include a{" "}
            <span className="font-semibold">“View original”</span> link to support creators. When a site doesn’t allow
            copying, we’ll just save the link.
          </div>
        </form>
