    ...
    <main className="min-h-dvh bg-zinc-50 text-zinc-900 flex flex-col">
      ...
      <header className="sticky top-0 z-20 bg-white/80 backdrop-blur border-b border-zinc-200">
        <div className="mx-auto max-w-screen-sm px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex flex-col items-center">
            <div className="text-xs uppercase tracking-wide text-zinc-500">Cook Mode</div>
      ...
      <section className="mx-auto max-w-screen-sm w-full px-4 pt-6 pb-28 flex-1">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <button className="h-16 rounded-2xl border border-zinc-200 bg-white text-base font-medium flex items-center justify-center gap-2">
            <List className="size-5" /> Ingredients
          </button>
          <button className="h-16 rounded-2xl border border-zinc-200 bg-white text-base font-medium flex items-center justify-center gap-2">
            <ListOrdered className="size-5" /> Steps
          </button>
          <button className="h-16 rounded-2xl border border-amber-300 bg-amber-50 text-amber-700 font-semibold flex items-center justify-center gap-2">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30">
        <div className="mx-auto max-w-screen-sm px-4 pb-5">
          <div className="grid grid-cols-2 gap-3">
            <button className="h-16 rounded-2xl bg-zinc-200 text-zinc-900 text-lg font-semibold flex items-center justify-center gap-2">
              <ChevronLeft className="size-5" /> Prev
            </button>
            <button className="h-16 rounded-2xl bg-emerald-600 text-white text-lg font-semibold flex items-center justify-center gap-2">
